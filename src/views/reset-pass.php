    ...
    <div class="container-fluid d-flex justify-content-center align-items-center">
        <div class="row row-cols-2 w-75">
            ...
            <div class="col d-flex flex-column align-items-center py-5 gap-5 h-100">
                ...
                <h5 class="dark-primary">Reseat your Password!</h5>
                <form action="../controller/resetPass.php" method="POST" class="d-flex flex-column gap-4">
                    <?php
                    ...
                    <div class="form-group d-flex flex-column gap-2">
                        ...
                        <input type="password" name="password" id="password" class="px-2 raduis5"
                            placeholder="enter your new password" />
                    </div>
                    <div class="form-group d-flex flex-column gap-2">
                        <label for="repassword">Recreate Password</label>
                        <input type="password" name="repassword" id="repassword" class="px-2 raduis5"
                            placeholder="enter your new password" />
                    </div>
                    ...
                    <div class="form-group">
                        <button class="btn raduis5 text-center">Set Password</button>
                    </div>
                </form>
            </div>
        </div>
