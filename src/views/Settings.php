        ...
        <div class="row w-100 me-0">
            <div class="col w-100">
                ...
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="colors-tab" data-bs-toggle="tab" data-bs-target="#colors" type="button" role="tab" aria-controls="colors" aria-selected="false">Color
                            Pallete</button>
                    </li>
                    <li class="nav-item" role="presentation">
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="general-tab" data-bs-toggle="tab" data-bs-target="#logo" type="button" role="tab" aria-controls="logo" aria-selected="false">logo</button>
                    </li>
                </ul>
                        ...
                        <div class="row py-3 mx-3 d-flex w-100 gap-3">
                            ...
                            <div class="row row-cols-1">
                                <div class="col">
                                    ...
                                    <input type="city" class="form-control" id="address2" name="address2" placeholder="Apartment, studio, or floor">
                                </div>
                            </div>
                            <div class="row row-cols-3">
                            ...
                            <div class="row row-cols-1 justify-content-end mt-3">
                                <div class="col">
                                    <button type="button" class="hpm-button" style="max-width: 150px;" id="update-button-general">Update</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="tab-pane fade" id="logo" role="tabpanel" aria-labelledby="logo-tab">
                        ...
                        <div class="row py-3 mx-3 d-flex w-100 gap-3">
                            <div class="drag-drop my-2 mx-5" style="position: relative;">
                                ...
                                <i id="show-logo" data-bs-toggle="modal" data-bs-target="#imageModal" class="fas fa-eye hpm-button-secondary"></i>
                                <div class="box">
                                    <img id="company-logo" src="../static/images/<?= $_SESSION['logo'] ?>" alt="Preview">
                                </div>
                                <i class="fas fa-gear" id="editLogo" data-bs-toggle="modal" data-bs-target="#updateLogo"></i>
                            </div>
                        </div>
                ...
                <div class="modal-dialog" style="max-width: 550px !important;">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <input type="color" class="form-control form-control-color" id="colorPicker" name="colorPicker" title="Choose your color">
                        </div>
            ...
            <div class="modal fade" id="imageModal" tabindex="-1" aria-labelledby="imageModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-body">
                            <img id="imageModalLabel" src="../static/images/<?= $_SESSION['logo'] ?>" class="img-fluid" alt="Large Image">
                        </div>
                    </div>
                </div>
            </div>
