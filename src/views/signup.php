      ...
      <div class="col d-flex flex-column align-items-center py-5 gap-3">
        ...
        <form action="../controller/signup.php" method="POST" class="d-flex flex-column gap-4 mt-4">
          ...
          <div class="form-group d-flex flex-column gap-2">
            ...
            <input type="text" name="name" id="name" class="px-2 raduis5" placeholder="enter your business name" value="<?= (isset($_SESSION['form_data']['name'])) ? $_SESSION['form_data']['name'] : '' ?>" />
          </div>
          <div class="form-group d-flex flex-column gap-2">
            <label for="username">User name : </label>
            <input type="text" name="username" id="username" class="px-2 raduis5" placeholder="enter your username" value="<?= (isset($_SESSION['form_data']['username'])) ? $_SESSION['form_data']['username'] : '' ?>" />
          </div>
          <div class="form-group d-flex flex-column gap-2">
            <label for="email">Email</label>
            <input type="email" name="email" id="email" class="px-2 raduis5" placeholder="enter your email address" value="<?= (isset($_SESSION['form_data']['email'])) ? $_SESSION['form_data']['email'] : '' ?>" />
          </div>
          <div class="form-group d-flex flex-column gap-2">
            <label for="password">Password</label>
            <input type="password" name="password" id="password" class="px-2 raduis5" placeholder="password" value="<?= (isset($_SESSION['form_data']['password'])) ? $_SESSION['form_data']['password'] : '' ?>" />
          </div>
