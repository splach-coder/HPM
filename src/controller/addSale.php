...
if (empty($produitID) || empty($clientID) || empty($prix) || empty($stock)) {
...
$query = "INSERT INTO `sales`(`product_id`, `client_id`, `company_id`, `quantity`, `price`, `Note`) VALUES (?, ?, ?, ?, ?, ?)";

$params = [$produitID, $clientID, $companyID, $stock, $prix, $note];
